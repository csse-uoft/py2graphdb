...
class TestUnitTestNode(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        owl_file = f'{TMP_DIR}unit_test_node3.owl'
        utest.save(owl_file)
    ...
    def test_1(self):
        with utest:
            ...
            test_inst0 = UnitTestNode3(inst_id=rr)
    ...
    def test_5(self):
        with utest:
            ...
            rr = int(np.random.rand()*10**10)
            rr1 = f"rdfs:{rr}"
            test_inst0 = UnitTestNode3(inst_id=rr1)
    ...
    def test_6(self):
        with utest:
            ...
            with self.assertRaises(ValueError):
                UnitTestNode3(inst_id=rr)

    def test_7(self):
        with utest:
            # test GraphNode.find_generate on existing
            test_inst0 = UnitTestNode3()
    ...
    def test_14(self):
        with utest:
            test_inst4 = UnitTestNode3(inst_id='utest:byebye_12345678')
    ...
    def test_23(self):
        with utest:
            ...
            test_inst9 = UnitTestNode3(inst_id=inst_id)
    ...
    def test_24(self):
        with utest:
            inst_id = f"utest.{int(np.random.rand()*10**10)}"
            test_inst10 = UnitTestNode3(inst_id=inst_id)
    ...
    def test_25(self):
        with utest:
            ...
            test_inst10_dict = SPARQLDict._get(klass='utest.UnitTestNode3', inst_id=inst_id)
            test_inst10_obj = UnitTestNode3.load_from_inst(inst=test_inst10_dict)
    ...
    def test_29(self):
        with utest:
            ...
            insts = SPARQLDict._search(klass=UnitTestNode3.klass, how='all')
    ...
    def test_30(self):
        with utest:
            ...
            insts = SPARQLDict._search(klass=UnitTestNode3.klass, how='all')
            nodes = UnitTestNode3.search(how='all')
            self.assertEqual(len(insts), len(nodes))

            node = UnitTestNode3.load_from_inst(inst=insts[-1])
    ...
    def test_31(self):
        with utest:
            ...
            test_inst10 = UnitTestNode3(inst_id=inst_id10)
            test_inst10.keep_db_in_synch = True
            test_inst10.one_int = rr1
            test_inst10.list_of_ints = rr2 
            test_inst10.list_of_ints = rr3 
            ...
            test_inst11 = UnitTestNode3(inst_id=inst_id11)
            ...
            test_inst12 = UnitTestNode3(inst_id=inst_id12)
            ...
            insts = SPARQLDict._search(klass=UnitTestNode3.klass, props={utest.hasListOfInts:rr2},how='all')
            nodes = UnitTestNode3.search(props={utest.hasListOfInts:rr2}, how='all')
            self.assertEqual(len(insts), len(nodes))
            ...
            insts = SPARQLDict._search(klass=UnitTestNode3.klass, props={utest.hasListOfInts:rr5},how='all')
            nodes = UnitTestNode3.search(props={utest.hasListOfInts:rr5}, how='all')
            self.assertEqual(len(insts), len(nodes))
            self.assertEqual(len(insts), 2)
            self.assertIn(insts[0]['ID'], [n.inst_id for n in nodes])
            self.assertIn(insts[1]['ID'], [n.inst_id for n in nodes])
            ...
            insts = SPARQLDict._search(klass=UnitTestNode3.klass, props={utest.hasListOfInts:rr8},how='all')
            nodes = UnitTestNode3.search(props={utest.hasListOfInts:rr8}, how='all')
            self.assertEqual(len(insts), len(nodes))
            ...
            insts = SPARQLDict._search(klass=UnitTestNode3.klass, props={utest.hasListOfInts:rr2},how='first')
            nodes = UnitTestNode3.search(props={utest.hasListOfInts:rr2}, how='first')
            self.assertEqual(len(insts), len(nodes))
            self.assertEqual(len(insts), 1)
            self.assertTrue((test_inst10.inst_id in [n.inst_id for n in nodes]) or (test_inst11.inst_id, [n.inst_id for n in nodes]))

            insts = SPARQLDict._search(klass=UnitTestNode3.klass, props={utest.hasListOfInts:rr5},how='first')
            nodes = UnitTestNode3.search(props={utest.hasListOfInts:rr5}, how='first')
            self.assertEqual(len(insts), len(nodes))
            self.assertEqual(len(insts), 1)
            self.assertIn(insts[0]['ID'], [n.inst_id for n in nodes])
            self.assertTrue((test_inst11.inst_id, [n.inst_id for n in nodes]) or (test_inst12.inst_id, [n.inst_id for n in nodes]))

            insts = SPARQLDict._search(klass=UnitTestNode3.klass, props={utest.hasListOfInts:rr8},how='first')
            nodes = UnitTestNode3.search(props={utest.hasListOfInts:rr8}, how='first')
            self.assertEqual(len(insts), len(nodes))
            self.assertEqual(len(insts), 1)
            self.assertIn(insts[0]['ID'], [n.inst_id for n in nodes])
            self.assertIn(test_inst12.inst_id, [n.inst_id for n in nodes])
    ...
    def test_32(self):
        with utest:
            ...
            test_inst10_copy = UnitTestNode3(inst_id=test_inst10.inst_id)
    ...
    def test_35(self):
        ...
        with utest:
            test_inst2 = UnitTestNode3(keep_db_in_synch = True)
            ...
            inst = SPARQLDict._get(klass=UnitTestNode3, inst_id=test_inst2.inst_id)
    ...
    def test_38(self):
        with utest:
            ...
            test_inst2.one_int_level3 = 336789
            test_inst2.list_of_ints_level3 = 3388991010
            test_inst2.list_of_ints_level3 = 33111112121313
